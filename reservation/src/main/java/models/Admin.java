...
public class Admin implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (idUser != admin.idUser) return false;
        if (idRole != null ? !idRole.equals(admin.idRole) : admin.idRole != null) return false;
        if (nomUser != null ? !nomUser.equals(admin.nomUser) : admin.nomUser != null) return false;
        if (prenomUser != null ? !prenomUser.equals(admin.prenomUser) : admin.prenomUser != null) return false;
        if (emailUser != null ? !emailUser.equals(admin.emailUser) : admin.emailUser != null) return false;
        if (passwordUser != null ? !passwordUser.equals(admin.passwordUser) : admin.passwordUser != null) return false;
